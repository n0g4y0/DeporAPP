...
// Task Extension
/*
* esta funcion convierte la TAREA (TASK) que hace FIRESTORE, en una funcion CORUTINA,
* que esperara por la respuesta, y luego emitira el OBJETO RESULTADO, con su correspondiente dato.
* */
